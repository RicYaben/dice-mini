...
app.command(
    "cli.recipes.app:recipes", group="D2", help="List or show available recipes"
)
app.command(
    "cli.modules.app:modules", group="D2", help="List or show available modules"
)
...
app.command("cli.report.app:report", group="D4", help="Generate reports")
